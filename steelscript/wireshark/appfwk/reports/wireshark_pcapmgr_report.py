...
from steelscript.wireshark.appfwk.datasources.wireshark_source \
    import WiresharkColumn, WiresharkPCAPMgrTable, WiresharkPCAPMgrInfoTable
...
table = WiresharkPCAPMgrInfoTable.create('pcap-info')
...
table = WiresharkPCAPMgrTable.create('pcap', resample=True,
...
table.add_column('iplen_ewma', synthetic=True, label="Moving Avg",
                 compute_expression=
                 'pandas.stats.moments.ewma({iplen}, span=20)',
                 compute_post_resample=True)
